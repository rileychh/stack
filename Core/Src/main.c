...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : USART2_RTS_Pin SPI1_SCK_Pin SPI1_MISO_Pin SPI1_MOSI_Pin */
  GPIO_InitStruct.Pin = USART2_RTS_Pin|SPI1_SCK_Pin|SPI1_MISO_Pin|SPI1_MOSI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : USART2_TX_Pin USART2_RX_Pin USART1_TX_Pin USART1_RX_Pin */
  GPIO_InitStruct.Pin = USART2_TX_Pin|USART2_RX_Pin|USART1_TX_Pin|USART1_RX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : MicroSDCard_D0_Pin MicroSDCard_D1_Pin MicroSDCard_D2_Pin MicroSDCard_D3_Pin
                           MicroSDCard_CLK_Pin */
  GPIO_InitStruct.Pin = MicroSDCard_D0_Pin|MicroSDCard_D1_Pin|MicroSDCard_D2_Pin|MicroSDCard_D3_Pin
                          |MicroSDCard_CLK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  ...
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Audio_PDN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : TemperatureSensor_INT_Pin */
  GPIO_InitStruct.Pin = TemperatureSensor_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_EVT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(TemperatureSensor_INT_GPIO_Port, &GPIO_InitStruct);
